...
//通用动态条件查询
exports.getlist = getlist;var query = function query(params) {var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};return http.post("mzsale/web/report/auto/condition/query", params, config);};



//更新商家信息
exports.query = query;var getSupplier = function getSupplier(params) {var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};return http.post("mzato/main/app/getSupplier", params, config);};
//商家销售
